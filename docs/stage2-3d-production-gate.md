...
| 0.40 / 1.40 | `anchor-3` 段丘崖、約0.42km | 樹洞へ一度視線を寄せる。中央道を空け、枝の順次揺れと小さな羽根印 |
...
- item cueは`feather-route-mark`。枝が進行方向へ順次揺れ、短い光波、小さな羽根印へ集まる。報酬本体と説明は2D層所有。
- animal cueは小鳥ピピの鳴き声＋枝揺れ＋一時シルエット。音OFFでも枝揺れと羽根印で理解できる。
...
8. 1024×768で横overflowなし。光波、羽根印、樹洞、門が上部HUDや下部typing overlayより強くならない。
