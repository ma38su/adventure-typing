...
export const ISLAND_GRAND_TOUR_STOPS: readonly IslandTourStop[] = [
  ...
  { id: 'wave-platform', name: '西海岸の千畳敷', description: '波が玄武岩を削った平坦な岩棚と潮だまり', eastKm: -6.85, northKm: 2.48, color: 0x718982 },
  { id: 'estuary', name: '南西の河口湿地', description: '南西谷川が沈水湾へ注ぐ葦と干潟の水辺', eastKm: -6.0, northKm: -0.2, color: 0x6ba795 },
  { id: 'beach', name: '岬裏のポケット浜', description: '玄武岩の岬に守られ、南岸へ弧を描いて歩ける白砂の浜', eastKm: -6.5, northKm: -4.0, color: 0xf2d58a },
  { id: 'spring-gorge', name: '湧水の谷', description: '溶岩の割れ目から清水が流れ出す涼しい谷', eastKm: -1.4, northKm: -1.0, color: 0x5d9e8f },
  { id: 'basalt-basin', name: '玄武岩柱の盆地', description: '古い溶岩窪地に草地と六角柱状の岩が点在する休息地', eastKm: 0.05, northKm: -0.25, color: 0x718979 },
...
export const ISLAND_GRAND_TOUR_ROUTE: readonly IslandTourRoutePoint[] = [
  ...
  { eastKm: -5.7, northKm: 3.25 },
  { eastKm: -6.1, northKm: 3.4 },
  { eastKm: -6.35, northKm: 3.12 },
  { eastKm: -6.12, northKm: 2.82 },
  { eastKm: -6.5, northKm: 2.67 },
  { eastKm: -6.85, northKm: 2.48, stopId: 'wave-platform' },
  { eastKm: -6.35, northKm: 1.35 },
  { eastKm: -6.0, northKm: -0.2, stopId: 'estuary' },
  { eastKm: -6.35, northKm: -0.7 },
  { eastKm: -6.55, northKm: -1.15 },
  { eastKm: -6.5, northKm: -1.65 },
  { eastKm: -6.45, northKm: -2.15 },
  { eastKm: -6.45, northKm: -2.65 },
  { eastKm: -6.5, northKm: -3.15 },
  { eastKm: -6.58, northKm: -3.6 },
  ...
  { eastKm: -0.75, northKm: -0.55 },
  { eastKm: 0.05, northKm: -0.25, stopId: 'basalt-basin' },
  { eastKm: 0.7, northKm: -1.35 },
