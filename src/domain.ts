...
export type ProfileData = { schemaVersion: 1; keyStats: KeyStats; collection: CollectionRecord[]; completedCourses: string[]; problemStats: ProblemStats; scoreData: ScoreData; dailyActivity: Record<string, DailyActivity>; goals: LearningGoals; tutorialCompletedAt: string }
...
export const emptyProfileData = (): ProfileData => ({ schemaVersion: 1, keyStats: {}, collection: [], completedCourses: [], problemStats: {}, scoreData: emptyScoreData(), dailyActivity: {}, goals: { dailyProblems: 5, weeklyProblems: 25 }, tutorialCompletedAt: '' })
